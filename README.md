# Time Series Forecasting by J.COp

# Starter Guide
## Step 1: Download materi
- Klik disini untuk [Download ZIP](https://codeload.github.com/WiraDKP/time_series/zip/master), atau
- Bagi yang familiar dengan git, boleh menggunakan clone
    ```
    git clone https://github.com/WiraDKP/time_series.git
    ```
...
- Change directory `cd` ke folder kerja ini
    ...
    cd time_series/
    ```
- Jalankan command ini untuk menginstall environment `jcop_ts`
    ```
...
- Jika sudah aman, maka akan muncul keterangan berikut, dan kita bisa mulai belajar. Semangat!
    ...
    ✓ Package telah terinstall dengan baik di dalam environment jcop_ts
